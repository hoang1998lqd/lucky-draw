            ...
            while (rows.hasNext()) {
                ...
                while (cellsInRow.hasNext()) {
                    ...
                    switch (cellIdx) {
                        ...
                        case 2:
                            tutorial.setChildDepartment(currentCell.getStringCellValue());
                            break;

                        case 3:
                            tutorial.setEmail(currentCell.getStringCellValue().toLowerCase(Locale.ENGLISH));
                            break;
                        case 4:
                            tutorial.setStatus((int) Math.round(currentCell.getNumericCellValue()));
                            break;
                        default:
                            break;
                    }
